...
//            jLabel5.setEnabled(true);
    ...
    //Display Saved customer to table--
    ...
    private void initComponents() {
        ...
        CustomersTable.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(CustNameTb, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(28, 28, 28)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(AddressTb, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel16, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(26, 26, 26)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(PhoneTb, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    //Autoincrement when new customer add--
    private void CountIt() {
     ...
     //Clear textfields after update the customer data--
    private void Clear() {
        CustNameTb.setText("");
        AddressTb.setText("");
        PhoneTb.setText("");
    ...
    private void SaveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveBtnActionPerformed
        ...
        if (CustNameTb.getText().isEmpty() || AddressTb.getText().isEmpty() || PhoneTb.getText().isEmpty()) {
            ...
            try {
                CountIt();
                Con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/petshopdb", "root", "");
                PreparedStatement Save = (PreparedStatement) Con.prepareStatement("insert into customerTbl values(?,?,?,?)");
    ...
    //if select the row from table that shows added customer, it will displays on TextFields
    int Key = 0;
