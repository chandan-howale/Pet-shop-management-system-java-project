...
public class Pets extends javax.swing.JFrame {
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(PetNameTb, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel15, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(CatCb, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(49, 49, 49)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(PetNameTb, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jLabel20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/menu-4-64.png"))); // NOI18N
        jLabel20.setMaximumSize(new java.awt.Dimension(512, 512));
        jLabel20.setMinimumSize(new java.awt.Dimension(512, 512));
        jLabel20.setPreferredSize(new java.awt.Dimension(554, 512));
    ...
    private void SaveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveBtnActionPerformed
        ...
        if (PetNameTb.getText().isEmpty() || QuantityTb.getText().isEmpty() || CatCb.getSelectedIndex() == -1 || PriceTb.getText().isEmpty()) {
            ...
            try {
                CountIt();
                Con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/petshopdb", "root", "");
                PreparedStatement Save = (PreparedStatement) Con.prepareStatement("insert into PetTbl values(?,?,?,?,?)");
    ...
    private void DeleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteBtnActionPerformed
        ...
        if(Key ==0)
        {
            ...
            try {
                Con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/petshopdb", "root", "");
                PreparedStatement Save = (PreparedStatement) Con.prepareStatement("Delete from PetTbl where PId=?");
                Save.setInt(1, Key);
